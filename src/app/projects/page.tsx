  ...
  return (
    <main className="flex-col justify-center items-center min-h-screen font-dm pt-16 px-4">
      ...
      <p className="pt-5 text-medium max-w-3xl leading-relaxed">
        Some are silly, some are serious, and some are special enough to earn
        that coveted spot on the fridge door. Each one represents a bit of my
        coding journey and love for building things.
      </p>
