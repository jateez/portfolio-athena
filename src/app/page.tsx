      ...
      <main className={`flex-col justify-center items-center min-h-screen font-dm pt-16 px-4`}>
        <div className="flex flex-col-reverse md:flex-row items-start w-full mx-auto justify-between gap-8 md:gap-12">
          <div className="flex-col items-center justify-start">
            ...
            <p className="pt-5 text-medium max-w-2xl leading-relaxed">
              I&apos;m a software engineer who enjoys building applications that make an impact and experimenting with new technologies. I recently graduated in Computer Science from Brawijaya University and hold the
              <span>
                {" "}
                <Link href="https://www.credly.com/badges/fa3218ce-66f6-4bb7-a9e1-6444f079b9a9/public_url" target="_blank" className="hover:text-[#FD9745]">
                  Google Certified Associate Cloud Engineer
                </Link>{" "}
              </span>
              credential. I’m also a distinction graduate from Bangkit Academy (Top 10%) and an honor scholarship awardee from Hacktiv8. I&apos;ve led small teams, worked on diverse projects, and enjoy solving real-world problems. In my
              free time, I enjoy building side projects and solving LeetCode problems.
            </p>
          </div>
        ...
        <section className="mt-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-y-4">
            ...
            {/* Cloud & DevOps */}
            <div>
              <p className="text-sm text-gray-600 mb-2">Others</p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-[#eeef9e] inline-flex items-center rounded-base border-2 text-black border-border dark:border-darkBorder px-2.5 font-base py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2">
                  AWS
                </span>
        ...
        <section className="mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featured_projects.map((project: FeaturedProject) => (
              <Card key={project.id} className="flex flex-col h-full transform transition-all duration-200 hover:-translate-y-boxShadowY">
                <CardHeader>
                ...
                <div className="px-6">
                  <div className="w-full h-48 overflow-hidden rounded-lg">
                    <img
                      loading="lazy"
                      src={project.imageUrl === "" ? "https://fastly.picsum.photos/id/828/900/900.jpg?hmac=YJ0SQkm34Bu0toWjo0d507t_jBwYY0TOB3tPxYnxTYQ" : project.imageUrl}
                      alt={project.name}
          ...
          <Link href={"/projects"} className="flex w-full mt-5 mb-6">
            <Card className="h-full w-full flex hover:bg-[#eeef9e] hover:translate-y-reverseBoxShadowX justify-center items-center transform transition-all duration-200">
              <CardTitle className=" mx-auto flex py-3">
                ...
                <svg width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2">
                  <path
