  ...
  return (
    <>
      <main className="flex-col justify-center items-center min-h-screen font-dm pt-16 px-4">
        ...
        <div className="flex flex-col container my-6 items-center">
          ...
          <h1 className="font-heading text-2xl md:text-3xl pt-3">
            <span className="border-b-4 border-main pb-1">work in progress!</span>
          </h1>
