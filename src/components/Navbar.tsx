    ...
    <nav className="sticky top-0 z-50 bg-[#fff4e0]/80 backdrop-blur-sm">
      <div className="mx-auto max-w-4xl py-6">
        <div className="flex justify-between items-center">
          ...
          >
            <h1
              className={`text-md md:text-xl font-extrabold tracking-tight font-dm hover:text-[#eeef9e]`}
            >
              jateez
            </h1>
          </Link>
        ...
        <button
          ...
          className="md:hidden mx-1 p-1.5 rounded-lg hover:bg-main transition-colors"
        >
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      <div
        className={`${isMenuOpen ? "flex" : "hidden"
          } md:hidden mx-2 flex-col space-y-3 pt-2 pb-3`}
      >
        <Link
          href={"/"}
          className={buttonVariants({
